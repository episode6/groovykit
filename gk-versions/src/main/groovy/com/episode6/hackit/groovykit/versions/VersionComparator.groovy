/**
 * Directly lifted from grails source:
  ...
  int compare(String o1, String o2) {
    ...
    if (o1 == '*') {
      ...
      try {
        ...
        throw new InvalidVersionException("Cannot compare versions, left side [$o1] is invalid: ${e.message}", e)
      }
      def nums2
      try {
        ...
        throw new InvalidVersionException("Cannot compare versions, right side [$o2] is invalid: ${e.message}", e)
      }
